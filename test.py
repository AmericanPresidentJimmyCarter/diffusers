...
output_image = model(prompt, num_inference_steps=30, generator=torch_g,
    cross_attention_kwargs={
        'layernorm_modulation_text': torch.zeros((2, 1024)).to('cuda'),
        'layernorm_modulation_prior': torch.zeros((2, 1024)).to('cuda'),
    }).images[0]
